    ...
    public partial class rbacsqlite : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "FunctionOperation",
                columns: new[] { "Id", "Code", "InterceptUrl", "Name", "ParentId" },
                values: new object[] { new Guid("6fa85f64-5717-4562-f3fc-2c963f66afa6"), "/api", "/api", "admin", new Guid("00000000-0000-0000-0000-000000000000") });

            migrationBuilder.InsertData(
                table: "Permission",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("5fa85f64-5717-4562-f3fc-2c963f66afa6"), "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "FunctionOperationId", "PermissionId" },
                values: new object[] { new Guid("dfab8c30-c4c9-4431-86ba-5a454bd45b05"), new Guid("6fa85f64-5717-4562-f3fc-2c963f66afa6"), new Guid("5fa85f64-5717-4562-f3fc-2c963f66afa6") });

            migrationBuilder.InsertData(
                table: "RolePermissionAss",
                columns: new[] { "Id", "PermissionId", "RoleId" },
                values: new object[] { new Guid("08f649fa-9292-4379-8c0d-b5c02198d201"), new Guid("5fa85f64-5717-4562-f3fc-2c963f66afa6"), new Guid("4fa85f64-5717-4562-f3fc-2c963f66afa6") });

            migrationBuilder.InsertData(
                table: "UserRoleAss",
                columns: new[] { "Id", "RoleId", "UserId" },
                values: new object[] { new Guid("6352afa9-95e6-4e05-a008-0f9a94c8b05e"), new Guid("4fa85f64-5717-4562-f3fc-2c963f66afa6"), new Guid("3fa85f64-5717-4562-f3fc-2c963f66afa6") });
